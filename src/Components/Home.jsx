...
const Home = () => {
  return (
    <div className='parent'>
        ...
        <div className='div1'>
            <span className='floar-right1'> <NavLink className='color-b'>View Food</NavLink> </span> 
            <span className='floar-right2'> <NavLink className='color-b'>Add Restaurant</NavLink> </span> 
        </div>
        <div className='div2'>   
